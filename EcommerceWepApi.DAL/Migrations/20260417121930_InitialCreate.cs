    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "أجهزة إلكترونية ومستلزماتها", null, true, false, "إلكترونيات", null },
                    { 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "ملابس رجالي ونسائي وأطفال", null, true, false, "ملابس", null },
                    { 3, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "كتب متنوعة في جميع المجالات", null, true, false, "كتب", null }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "City", "Country", "CreatedAt", "Email", "IsActive", "IsDeleted", "Name", "Password", "Phone", "PostalCode", "RefreshToken", "RefreshTokenExpiryTime", "Role", "UpdatedAt" },
                values: new object[] { 1, "القاهرة", "القاهرة", "مصر", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@ecommerce.com", true, false, "مدير النظام", "AdminPassword123Hashed", "0100000000", "11511", null, null, "Admin", null });
